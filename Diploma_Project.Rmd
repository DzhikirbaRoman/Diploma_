...
ggsave(file = file.path(PlotsFolder,"GSEA_cnetplot_Desc_TOP5.svg"), plot = GSEA_cnetplot_Desc_TOP10, 
       width = 10, height = 8)
...
ggsave(file = file.path(PlotsFolder,"GSEA_cnetplot_Asc_TOP5.svg"), plot = GSEA_cnetplot_Asc_TOP10, 
       width = 10, height = 8)
