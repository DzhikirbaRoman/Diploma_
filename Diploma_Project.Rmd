...
PC_1_2_sample_contr <- fviz_pca_ind(pca,
             ...
             repel = TRUE )
PC_1_2_sample_contr
ggsave(file = file.path(PlotsFolder,"PC_1_2_genes_contr.svg"), plot = PC_1_2_sample_contr, width=10, height=8)
...
GSEA_Emapplot_Top30 <- emapplot(enriched_terms, showCategory = 30, cex_label_category = 0.8)
GSEA_Emapplot_Top30
ggsave(file = file.path(PlotsFolder,"GSEA_Emapplot_Top30.svg"), plot = GSEA_Emapplot_Top30, 
       width = 10, height = 8)
...
GSEA_cnetplot_Desc_TOP10 <- cnetplot(GSE.Arranged.Desc_order, categorySize="pvalue", foldChange = gene_list, 
                                showCategory = 10, # 20
...
ridgeplot
ggsave(file = file.path(PlotsFolder,"GSEA_ridgeplot_.svg"), plot = ridgeplot, 
       width = 12, height = 10)
...
heatplot(gse, foldChange = gene_list , showCategory = 5)
treeplot(enriched_terms, showCategory = 30)
